"""
Detects the name of the card by OCR
"""
...
def find_card_name(im, debug):
    ...
    :param im: (npa) image processed
    :param debug: (bool) toggles the saving of intermediary images for debug processes
    :return: (string) detected text of the name of the card
    """
